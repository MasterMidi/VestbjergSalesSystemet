...
public class TryMe {
	...
	public TryMe() {
		...
		for (int i = 0; i < 100000; i++) {
			customerController.createPrivateCustomer("Kunde " + i, "hey" + i + "@gmail.com", String.valueOf(i),
					"Somewhere", "67890243-1233", null);
			productController.createSellableProduct("Skruetrækker " + String.valueOf(i), String.valueOf(i), "something",
					1d, 1);
		}
